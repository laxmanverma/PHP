<?php /* Smarty version 2.6.30, created on 2017-07-26 17:21:44
...
<body>
    ...
    <table style="width:100%;border :5px solid black;">
      ...
      <tr>
        <th><?php echo $this->_tpl_vars['ID']; ?>
</th>
        <th><?php echo $this->_tpl_vars['empname']; ?>
</th>
        <th><?php echo $this->_tpl_vars['empemail']; ?>
</th>
        <th><?php echo $this->_tpl_vars['department']; ?>
</th>
        <th><?php echo $this->_tpl_vars['delete']; ?>
</th>
      </tr>
    </table>
